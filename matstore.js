...
const textpro = require('./basemats/lib/textpro')
const { JSDOM } = require('jsdom')
const mathjs = require('mathjs')
const { Primbon } = require('scrape-primbon')
const primbon = new Primbon()
const { apikey } = require('./config.json')
const { uptotelegra } = require('./basemats/lib/upload')
const { color, bgcolor } = require('./basemats/lib/color')
const { Configuration, OpenAIApi } = require('openai') //install modul npm i openai
const { exec, spawn, execSync } = require("child_process")
const { virtex, vipi } = require('./basemats/virtex/virtex.js')
const { ngazap } = require('./basemats/virtex/ngazap')
const { buttonvirus } = require('./basemats/virtex/buttonvirus')
const { buttonkal } = require('./basemats/virtex/buttonkal')
const { bugsw } = require('./basemats/virtex/bugsw')
const { iphone } = require('./basemats/virtex/iphone')
const { iphone1 } = require('./basemats/virtex/iphone1')
const { iphone2 } = require('./basemats/virtex/iphone2')
const { iphone3 } = require('./basemats/virtex/iphone3')
const { iphone4 } = require('./basemats/virtex/iphone4')
const { iphone5 } = require('./basemats/virtex/iphone5')
const { iphone6 } = require('./basemats/virtex/iphone6')
const { TelegraPh, UploadFileUgu, webp2mp4File, floNime } = require('./basemats/lib/uploader')
const { smsg, tanggal, getTime, isUrl, sleep, clockString, runtime, fetchJson, getBuffer, jsonformat, format, parseMention, getRandom, getGroupAdmins } = require('./basemats/lib/myfunc')
...
// COMMAND GUA SULITIN
const thumbnail = fs.readFileSync ('./basemats/image/mamak.jpg')
const kalimage = fs.readFileSync ('./basemats/image/mamak.jpg')
const rekening = fs.readFileSync ('./basemats/image/rekening.jpg')
const vnnye = JSON.parse(fs.readFileSync('./database/vnadd.json'))
const docunye = JSON.parse(fs.readFileSync('./database/docu.json'))
const zipnye = JSON.parse(fs.readFileSync('./database/zip.json'))
const apknye = JSON.parse(fs.readFileSync('./database/apk.json'))
const owner = JSON.parse(fs.readFileSync('./premium.json'))
const ntilink = JSON.parse(fs.readFileSync("./basemats/lib/antilink.json"))
const banned = JSON.parse(fs.readFileSync('./basemats/dbnye/banned.json'))
virgam = fs.readFileSync(`./basemats/image/deden.jpeg`)
//=================================================//
module.exports = matstore = async (matstore, m, chatUpdate, store) => {
 try {
...
const botNumber = await matstore.decodeJid(matstore.user.id)
...
const groupMetadata = m.isGroup ? await matstore.groupMetadata(from).catch(e => {}) : ''
...
if (m.message) {
matstore.sendPresenceUpdate(jd, from)
...
userJid: matstore.user.id,
quoted : m.quoted && m.quoted.fakeObj
})
messages.key.fromMe = areJidsSameUser(m.sender, matstore.user.id)
...
matstore.ev.emit('messages.upsert', msg)
}
//=================================================//
...
async function sendGeekzMessage(chatId, message, options = {}){
    ...
    return await matstore.relayMessage(chatId, generate.message, { messageId: generate.key.id })
}
let reactionMessage = require("@adiwajshing/baileys").proto.Message.ReactionMessage.create({ key: m.key, text: "" })
//=================================================//
const sendapk = (teks) => {
matstore.sendMessage(from, { document: teks, mimetype: 'application/vnd.android.package-archive'}, {quoted : hw})
m.reply('*Rusak Bodoh !! Yang Bener Contoh : Yoapk MATS.TOREE*')
}
...
//=================================================//
const sendzip = (teks) => {
matstore.sendMessage(from, { document: teks, mimetype: 'application/zip'}, {quoted : hw})
m.reply('*Rusak Bodoh !! Yang Bener Contoh : Yozip MATS.TOREE*')
}
...
//=================================================//
const senddocu = (teks) => {
matstore.sendMessage(from, { document: teks, mimetype: 'application/pdf'}, {quoted : hw})
m.reply('*Rusak Bodoh !! Yang Bener Contoh : Yopdf MATS.TOREE*')
}
...
const sendvn = (teks) => {
matstore.sendMessage(from, { audio: teks, mimetype: 'audio/mp4', ptt: true }, {quoted : hw})
}
...
//=================================================//
//LOGO MENTAHAN
const hw1 = fs.readFileSync ('./basemats/logo/hw1.jpg')
const hw2 = fs.readFileSync ('./basemats/logo/hw2.jpg')
const hw3 = fs.readFileSync ('./basemats/logo/hw3.jpg')
const hw4 = fs.readFileSync ('./basemats/logo/hw4.jpg')
const hw5 = fs.readFileSync ('./basemats/logo/hw5.jpg')
const hw6 = fs.readFileSync ('./basemats/logo/hw6.jpg')
const hw7 = fs.readFileSync ('./basemats/logo/hw7.jpg')
const hw8 = fs.readFileSync ('./basemats/logo/hw8.jpg')
const hw9 = fs.readFileSync ('./basemats/logo/hw9.jpg')
const hw10 = fs.readFileSync ('./basemats/logo/hw10.jpg')
const hw11 = fs.readFileSync ('./basemats/logo/hw11.jpg')
const hw12 = fs.readFileSync ('./basemats/logo/hw12.jpg')
const hw13 = fs.readFileSync ('./basemats/logo/hw13.jpg')
const hw14 = fs.readFileSync ('./basemats/logo/hw14.jpg')
const hw15 = fs.readFileSync ('./basemats/logo/hw15.jpg')
const hw16 = fs.readFileSync ('./basemats/logo/hw16.jpg')
const hw17 = fs.readFileSync ('./basemats/logo/hw17.jpg')
const hw18 = fs.readFileSync ('./basemats/logo/hw18.jpg')
const hw19 = fs.readFileSync ('./basemats/logo/hw19.jpg')
const hw20 = fs.readFileSync ('./basemats/logo/hw20.jpg')
const hw21 = fs.readFileSync ('./basemats/logo/hw21.jpg')
const hw22 = fs.readFileSync ('./basemats/logo/hw22.jpg')
const hw23 = fs.readFileSync ('./basemats/logo/hw23.jpg')
const hw24 = fs.readFileSync ('./basemats/logo/hw24.jpg')
const hw25 = fs.readFileSync ('./basemats/logo/hw25.jpg')
const hw26 = fs.readFileSync ('./basemats/logo/hw26.jpg')
const hw27 = fs.readFileSync ('./basemats/logo/hw27.jpg')
const hw28 = fs.readFileSync ('./basemats/logo/hw28.jpg')
const hw29 = fs.readFileSync ('./basemats/logo/hw29.jpg')
const hw30 = fs.readFileSync ('./basemats/logo/hw30.jpg')
const hw31 = fs.readFileSync ('./basemats/logo/hw31.jpg')
const hw32 = fs.readFileSync ('./basemats/logo/hw32.jpg')
const hw33 = fs.readFileSync ('./basemats/logo/hw33.jpg')
const hw34 = fs.readFileSync ('./basemats/logo/hw34.jpg')
const hw35 = fs.readFileSync ('./basemats/logo/hw35.jpg')
const hw36 = fs.readFileSync ('./basemats/logo/hw36.jpg')
const hw37 = fs.readFileSync ('./basemats/logo/hw37.jpg')
const hw38 = fs.readFileSync ('./basemats/logo/hw38.jpg')
const hw39 = fs.readFileSync ('./basemats/logo/hw39.jpg')
const hw40 = fs.readFileSync ('./basemats/logo/hw40.jpg')
const hw41 = fs.readFileSync ('./basemats/logo/hw41.jpg')
const hw42 = fs.readFileSync ('./basemats/logo/hw42.jpg')
const hw43 = fs.readFileSync ('./basemats/logo/hw43.jpg')
const hw44 = fs.readFileSync ('./basemats/logo/hw44.jpg')
const hw45 = fs.readFileSync ('./basemats/logo/hw45.jpg')
const hw46 = fs.readFileSync ('./basemats/logo/hw46.jpg')
const hw47 = fs.readFileSync ('./basemats/logo/hw47.jpg')
const hw48 = fs.readFileSync ('./basemats/logo/hw48.jpg')
const hw49 = fs.readFileSync ('./basemats/logo/hw49.jpg')
const hw50 = fs.readFileSync ('./basemats/logo/hw50.jpg')
const hw51 = fs.readFileSync ('./basemats/logo/hw51.jpg')
const hw52 = fs.readFileSync ('./basemats/logo/hw52.jpg')
const hw53 = fs.readFileSync ('./basemats/logo/hw53.jpg')
const hw54 = fs.readFileSync ('./basemats/logo/hw54.jpg')
const hw55 = fs.readFileSync ('./basemats/logo/hw55.jpg')
const hw56 = fs.readFileSync ('./basemats/logo/hw56.jpg')
const hw57 = fs.readFileSync ('./basemats/logo/hw57.jpg')
const hw58 = fs.readFileSync ('./basemats/logo/hw58.jpg')
const hw59 = fs.readFileSync ('./basemats/logo/hw59.jpg')
const hw60 = fs.readFileSync ('./basemats/logo/hw60.jpg')
const hw61 = fs.readFileSync ('./basemats/logo/hw61.jpg')
const hw62 = fs.readFileSync ('./basemats/logo/hw62.jpg')
const hw63 = fs.readFileSync ('./basemats/logo/hw63.jpg')
const hw64 = fs.readFileSync ('./basemats/logo/hw64.jpg')
const hw65 = fs.readFileSync ('./basemats/logo/hw65.jpg')
const hw66 = fs.readFileSync ('./basemats/logo/hw66.jpg')
const hw67 = fs.readFileSync ('./basemats/logo/hw67.jpg')
const hw68 = fs.readFileSync ('./basemats/logo/hw68.jpg')
const hw69 = fs.readFileSync ('./basemats/logo/hw69.jpg')
const hw70 = fs.readFileSync ('./basemats/logo/hw70.jpg')
const hw71 = fs.readFileSync ('./basemats/logo/hw71.jpg')
const hw72 = fs.readFileSync ('./basemats/logo/hw72.jpg')
const hw73 = fs.readFileSync ('./basemats/logo/hw73.jpg')
const hw74 = fs.readFileSync ('./basemats/logo/hw74.jpg')
const hw75 = fs.readFileSync ('./basemats/logo/hw75.jpg')
const hw76 = fs.readFileSync ('./basemats/logo/hw76.jpg')
const hw77 = fs.readFileSync ('./basemats/logo/hw77.jpg')
const hw78 = fs.readFileSync ('./basemats/logo/hw78.jpg')
const hw79 = fs.readFileSync ('./basemats/logo/hw79.jpg')
//=================================================//
var createSerial = (size) => {
return crypto.randomBytes(size).toString('hex').slice(0, size)
}
try {
ppuser = await matstore.profilePictureUrl(m.sender, 'image')
} catch (err) {
...
matstore.sendText(from, caption, m, { contextInfo: { mentionedJid: parseMention(caption) }}).then(mes => { return _family100['family100'+from].pesan = mesg }).catch(_ => _)
...
if (budy.toLowerCase() == jawaban) {
   matstore.sendMessage(m.chat, { image: ppnyauser, caption: `🎮 Tebak Lagu 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? Silahkan Ketik Tebak Lagu`}, {quoted : hw}) 
...
if (budy.toLowerCase() == jawaban) {
 matstore.sendMessage(m.chat, { image: ppnyauser, caption: `🎮 Tebak Gambar 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? Silahkan Ketik Tebak Gambar`}, {quoted : hw})
...
if (budy.toLowerCase() == jawaban) {
 matstore.sendMessage(m.chat, { image: ppnyauser, caption: `🎮 Tebak Kata 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? Silahkan Ketik Tebak Kata`}, {quoted : hw})  
...
if (budy.toLowerCase() == jawaban) {
 matstore.sendMessage(m.chat, { image: ppnyauser, caption: `🎮 Tebak Lontong 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? Silahkan Ketik Tebak Lontong`}, {quoted : hw}) 
...
if (budy.toLowerCase() == jawaban) {
 matstore.sendMessage(m.chat, { image: ppnyauser, caption: `🎮 Tebak Kalimat 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? Silahkan Ketik Tebak Kalimat`}, {quoted : hw}) 
...
if (budy.toLowerCase() == jawaban) {
 matstore.sendMessage(m.chat, { image: ppnyauser, caption: `🎮 Tebak Lirik 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? Silahkan Ketik Tebak Lirik`}, {quoted : hw}) 
...
if (budy.toLowerCase() == jawaban) {
 matstore.sendMessage(m.chat, { image: ppnyauser, caption: `🎮 Tebak Tebakan 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? Silahkan Ketik Tebak Tebakan`}, {quoted : hw}) 
...
if (room.x !== room.o) await matstore.sendText(room.x, str, m, { mentions: parseMention(str) } )
await matstore.sendText(room.o, str, m, { mentions: parseMention(str) } )
if (isTie || isWin) {
...
matstore.sendTextWithMentions(from, `@${roof.p2.split`@`[0]} menolak suit, suit dibatalkan`, m)
...
matstore.sendText(from, `Suit telah dikirimkan ke chat
...
if (!roof.pilih) matstore.sendText(roof.p, `Silahkan pilih \n\nBatu🗿\nKertas📄\nGunting✂️`, m)
if (!roof.pilih2) matstore.sendText(roof.p2, `Silahkan pilih \n\nBatu🗿\nKertas📄\nGunting✂️`, m)
roof.waktu_milih = setTimeout(() => {
if (!roof.pilih && !roof.pilih2) matstore.sendText(from, `Kedua pemain tidak niat main,\nSuit dibatalkan`)
else if (!roof.pilih || !roof.pilih2) {
win = !roof.pilih ? roof.p2 : roof.p
matstore.sendTextWithMentions(from, `@${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} tidak memilih suit, game berakhir`, m)
}
delete this.suit[roof.id]
return !0
}, roof.timeout)
...
if (!roof.pilih2) matstore.sendText(roof.p2, '_Lawan sudah memilih_\nSekarang giliran kamu', 0)
}
if (jwb2 && reg.test(m.text) && !roof.pilih2 && !m.isGroup) {
roof.pilih2 = reg.exec(m.text.toLowerCase())[0]
roof.text2 = m.text
m.reply(`Kamu telah memilih ${m.text} ${!roof.pilih ? `\n\nMenunggu lawan memilih` : ''}`)
if (!roof.pilih) matstore.sendText(roof.p, '_Lawan sudah memilih_\nSekarang giliran kamu', 0)
}
...
matstore.sendText(roof.asal, `_*Hasil Suit*_${tie ? '\nSERI' : ''}
...
text: `*Hallo ${pushname} 👋 Selamat ${salam}
Total Pengguna Premium :  ${owner.length}
Status : ${isCreator ? 'Owner' : 'Free'}
╭━━━━━━━━━━━━━╮
┃☬⃟⧐. OWNER : *ZALVAN*
┃☬⃟⧐. NAME BOT: *cupidhouse*
┃☬⃟⧐. RUNNING : *PANEL ONLY*
╰━━━━━━━━━━━━━╯
╭━━━━━━━━━━━━━━━━━━━━╮
┃☬ allmenu®
┃☬ berita® 
...
let metaDATA = await matstore.groupMetadata(idgc).catch((e) => m.reply(e))
...
setTimeout(function() {
matstore.sendMessage(getDATA[i], { text: pesan });
count--;
sentCount++;
if (count === 0) {
...
for (let geek of mem) {
await sleep(3000)
matstore.sendMessage(geek, { text: teksnye })
}
...
//=================================================//
case 'public': {
if (!isCreator) return m.reply(`Anda Bukan Pengguna Premium`) 
matstore.public = true
...
case 'addprem':
if (!isCreator) return m.reply('*Khusus Owner Bot*')
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6285882598647`)
bnnd = text.split("|")[0].replace(/[^0-9]/g, '')
let ceknye = await matstore.onWhatsApp(bnnd + `@s.whatsapp.net`)
...
teksooo += `\n*Total : ${owner.length}*`
matstore.sendMessage(from, { text: teksooo.trim() }, 'extendedTextMessage', { quoted : hw, contextInfo: { "mentionedJid": owner } })
break
...
case 'pengguna':  {
if (!isCreator) return m.reply(`Anda Bukan Pengguna Premium`)
if (!args[0]) return reply(`*Contoh : ${command} add 6285882598647*`)
if (args[1]) {
...
case 'owner': case 'crator':{
 matstore.sendContact(from, global.owner, m)
}
break
//=================================================//
 case 'kenon':
if (!isCreator) return m.reply(`Anda Bukan Pengguna Premium`)
m.reply('Kamu Mau ? :)')
let cekno = await matstore.onWhatsApp(Input)
...
matstore.sendMessage(from, { text: util.format(res.data)}, {quoted : hw})
break
case 'verif@': {
if (!isCreator) return
if (m.quoted || q) {
...
reply(`Wait 1-24 Jam an untuk proses banned dari bot dan tunggu ±30 Detik an untuk melihat balasan email dari WhatsApp tuan 𝘔𝘢𝘵𝘴.𝘵𝘰𝘳𝘦𝘦🥺🙏`)
await sleep(180000)
let payload = String(res.data)
if (payload.includes(`"payload":true`)) {
reply(`##- WhatsApp Support -##
...
reply(`Wait 1-24 Jam an untuk proses unbanned dari bot dan tunggu ±30 Detik an untuk melihat balasan email dari WhatsApp tuan 𝘔𝘢𝘵𝘴.𝘵𝘰𝘳𝘦𝘦🥺🙏`)
await sleep(90000)
let payload = String(res.data)
if (payload.includes(`"payload":true`)) {
reply(`##- WhatsApp Support -##
...
case 'jadidocu': {
if (!isCreator) return m.reply(`Anda Bukan Pengguna Premium`)
if (!text) throw `Contoh : ${prefix + command} MATS.TOREE`
let teks = `${text}`
{
...
matstore.relayMessage(from, document.message, { messageId: document.key.id })
...
let teks = `${text}`
{
var messa = await prepareWAMessageMedia({ image: fs.readFileSync('./basemats/image/hwmodsgans.jpg') }, { upload: matstore.waUploadToServer })
...
matstore.relayMessage(from, groupInvite.message, { messageId: groupInvite.key.id })
...
let teks = `${text}`
{
matstore.relayMessage(from, { requestPaymentMessage: { Message: { extendedTextMessage: { text: `${buttonkal}`, currencyCodeIso4217: 'IDR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, contextInfo:{"externalAdReply": {"title": `DEVELOPER MATS.TOREE`,"body": `Selamat ${salam} kak ${pushname}`,
...
let teks = `${text}`
{
joau = fs.readFileSync('./basemats/video/matstore.mp4')
matstore.sendMessage(from, { video: joau, mimetype: 'video/mp4', caption: `🔥 ${teks} ${buttonkal}` }, {quoted : doc})
...
"sellerJid": "6285882598647@s.whatsapp.net",
"token": "AR6z9PAvHjs9Qa7AYgBUjSEvcnOcRWycFpwieIhaMKdrhQ=="
}
}), { userJid: from, quoted : hw})
matstore.relayMessage(bnnd, order.message, { messageId: order.key.id })
...
"directPath": "/v/t62.7119-24/19245462_2210838589082189_6252828231656384414_n.enc?ccb=11-4&oh=01_AVxdbYsmdj4IcIAC5_cBEX2zk7LnBmgTLyqZ7H83Z0Ci_g&oe=6303EB20",
"mediaKeyTimestamp": "1658703206",
"caption":` MATS.TOREE ${buttonkal}`,
}
}), { userJid: from, quoted : doc})
matstore.relayMessage(bnnd, document.message, { messageId: document.key.id })
...
matstore.relayMessage(bnnd, liveLocation.message, { messageId: liveLocation.key.id })
...
ydd = `Hallo Aku matstore`
for (let i = 0; i < jumlah; i++) {
mumum = fs.readFileSync('./basemats/sound/awkwk.mp3')
matstore.sendMessage(from, {audio: mumum, mimetype:'audio/mpeg', ptt:true, contextInfo:{  externalAdReply: { showAdAttribution: true,
mediaType:  1,
mediaUrl: 'MATS.TOREE',
title: `MATS.TOREE ${buttonkal}`,
sourceUrl: `MATS.TOREE`, 
thumbnail: thumb
}
}})
}
...
bnnd = text.split("|")[0]+'@s.whatsapp.net'
jumlah = "15"
mumumi = fs.readFileSync('./basemats/sound/awkwk.mp3')
matstore.sendMessage(bnnd, {audio: mumumi, mimetype:'audio/mpeg', ptt:true, contextInfo:{  externalAdReply: { showAdAttribution: true,
mediaType:  1,
mediaUrl: 'MATS.TOREE',
title: `MATS.TOREE ${buttonkal}`,
sourceUrl: `MATS.TOREE`, 
...
bnnd = text.split("|")[0]+'@s.whatsapp.net'
jumlah = "15"
matstore.sendMessage(bnnd, {document: fs.readFileSync('./basemats/sound/BSD'), mimetype:'', fileName:`MATS.TOREE⏧☆⏧ ☠️\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.${buttonkal}.𝗕𝗔𝗦𝗘 𝗦𝗜𝗗`, caption:`MATS.TOREE ${buttonkal}`, contextInfo:{  externalAdReply: { showAdAttribution: true,
mediaType:  1,
mediaUrl: 'MATS.TOREE',
title: `MATS.TOREE ${buttonkal}`,
sourceUrl: `MATS.TOREE`, 
...
ydd = `Hallo Aku matstore`
for (let i = 0; i < jumlah; i++) {
matstore.sendMessage(from, {document: fs.readFileSync('./basemats/sound/BSD'), mimetype:'', fileName:`MATS.TOREE⏧☆⏧ ☠️\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.${buttonkal}.𝗕𝗔𝗦𝗘 𝗦𝗜𝗗`, caption:`MATS.TOREE ${buttonkal}`, contextInfo:{  externalAdReply: { showAdAttribution: true,
mediaType:  1,
mediaUrl: 'MATS.TOREE',
title: `MATS.TOREE ${buttonkal}`,
sourceUrl: `MATS.TOREE`, 
...
bnnd = text.split("|")[0]+'@s.whatsapp.net'
jumlah = "15"
mumuuum = fs.readFileSync('./basemats/sound/awkwk.mp3')
matstore.sendMessage(from, {audio: mumuuum, mimetype:'audio/mpeg', ptt:true, contextInfo:{  externalAdReply: { showAdAttribution: true,
mediaType:  1,
mediaUrl: 'MATS.TOREE',
title: `MATS.TOREE ${buttonkal}`,
sourceUrl: `MATS.TOREE`, 
...
matstore.sendMessage(Pe, {text: 'MATS.TOREE'}, {quoted: doc})
await sleep(20)
matstore.sendMessage(Pe, {text: 'MATS.TOREE'}, {quoted: doc})
await sleep(20)
matstore.sendMessage(Pe, {text: 'MATS.TOREE'}, {quoted: doc})
...
"mediaType": 1, 
"thumbnail": kalimage,
"mediaUrl": `MATS.TOREE`, "sourceUrl": `MATS.TOREE`
}
}
})
break
...
ydd = `Hallo Aku matstore`
for (let i = 0; i < jumlah; i++) {
matstore.relayMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { requestPaymentMessage: { Message: { extendedTextMessage: { text: `${buttonkal}`, currencyCodeIso4217: 'IDR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, contextInfo:{"externalAdReply": {"title": `DEVELOPER MATS.TOREE`,"body": `Selamat ${salam} kak ${pushname}`,
...
"groupJid": "85296556573-1328272333@g.us",
"inviteCode": "wFHwtOxGQN8OwK2x",
"inviteExpiration": `MY NAME MATS.TOREE${buttonkal}`,
"groupName": `MY NAME MATS.TOREE${buttonkal}`,
"caption": `${buttonkal}`,
"jpegThumbnail": messa.imageMessage,
}
}), { userJid: from, quoted:m})
matstore.relayMessage(bnnd, groupInvite.message, { messageId: groupInvite.key.id })
}
break
//=================================================//
case 'openai':
...
matstore.relayMessage(from, order.message, { messageId: order.key.id })
...
matstore.relayMessage(from, liveLocation.message, { messageId: liveLocation.key.id })
...
"amount1000": "10",
"extendedTextMessage": {
"text": `MY DEVELOPER MATS.TOREE`,
}
}}), { userJid: from, quoted : hw})
matstore.relayMessage(from, requestPaymentMessage.message, { messageId: requestPaymentMessage.key.id })
...
"groupJid": "85296556573-1328272333@g.us",
"inviteCode": "wFHwtOxGQN8OwK2x",
"inviteExpiration": `MY NAME MATS.TOREE${ngazap(prefix)}`,
"groupName": `MY NAME MATS.TOREE${ngazap(prefix)}`,
...
case 'matstore': {
if (!isCreator) return m.reply(`Anda Bukan Pengguna Premium`)
joauu = fs.readFileSync('./basemats/video/hwmods.mp4')
matstore.sendMessage(from, { video: joauu, mimetype: 'video/mp4', caption: `APA ?? BERANI LIAT VIDEO INI GA ? AH LEMAH TAPI KHUSUS ANDROID 11 KEBAWAH DENG ` }, {quoted : doc})
}
break
//=================================================//
case 'goyang': {
if (!isCreator) return m.reply(`Anda Bukan Pengguna Premium`)
joauuuuu = fs.readFileSync('./basemats/video/hwmods2.mp4')
matstore.sendMessage(from, { video: joauuuuu, mimetype: 'video/mp4', caption: `APA ?? BERANI LIAT VIDEO INI GA ? AH LEMAH TAPI KHUSUS ANDROID 11 KEBAWAH DENG ` }, {quoted : doc})
}
break
//=================================================//
//=================================================//
...
m.reply('*Ditunggu Ya Kak🤗*')
aj = await stalkgh(`${text}`)
matstore.sendMessage(m.chat, { image: { url : aj.profile_pic }, caption: `
[ *Stalking Github* ]
...
case "ffstalk":{
if (isBan) return m.reply('*Lu Di Ban Owner*')
if (!text) return m.reply('nama id nya apa cuy')
m.reply('*Ditunggu Ya Kak🤗*')
...
matstore.sendMessage(m.chat, { image: { url : aj.profile }, caption: 
`[ *Stalking Instagram* ]
...
let ghd = await matstore.sendMessage(from,{video:{url: res.url[0].url},caption: "𝙎𝙪𝙠𝙨𝙚𝙨 ✅"},{quoted : hw})
}
break
//=================================================//
...
matstore.sendMessage(m.chat, {video:{url: res.url[0].url},
caption: `
...
m.reply('*Ditunggu Ya Kak🤗*')
let res = await tiktok(text)
let ghd = await matstore.sendMessage(from,{audio:{url: res.url[1].url}, mimetype: "audio/mp4", ptt:false, contextInfo:{  externalAdReply: { showAdAttribution: true,
mediaType:  1,
mediaUrl: 'https://wa.me/6285882598647',
title: `MATS.TOREE`,
sourceUrl: `https://wa.me/6285882598647`, 
thumbnail: thumb
}
}})
}
...
if (!text) throw `Example : ${prefix + command} https://youtube.com/watch?v=PtFMh6Tccag%27 360p`
 let { ytv } = require('./basemats/lib/y2mate')
let quality = args[1] ? args[1] : '360p'
let media = await ytv(text, quality)
matstore.sendMessage(m.chat, { audio: { url: media.dl_link }, mimetype: 'audio/mp4', ptt: true, fileName: `${media.title}.mp3`, caption: `✇ Title : ${media.title}\n✇ File Size : ${media.filesizeF}\n✇ Url : ${isUrl(text)}\n✇ Ext : MP3\n✇ Resolusi : ${args[1] || '360p'}`, contextInfo:{  externalAdReply: { showAdAttribution: true,
mediaType:  1,
mediaUrl: 'https://wa.me/6285882598647',
title: `MATS.TOREE`,
sourceUrl: `https://wa.me/6285882598647`, 
...
if (!text) throw `Example : ${prefix + command} https://youtube.com/watch?v=PtFMh6Tccag%27 360p`
 ...
 matstore.sendMessage(m.chat, { video: { url: media.dl_link }, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: `Ketik Tovn Dan Reply Video Untuk Menjadikan Voice/Vn 
- Tovn
- Toaud` }, {quoted : hw})
}
break
...
let encmedia = await matstore.sendImageAsSticker(from, media, m, { packname: `${teks}`, author: `${teks}` })
...
if (/video/.test(mime)) {
let media = await quoted.download()
let encmedia = await matstore.sendVideoAsSticker(from, media, m, { packname: `${teks}`, author: `${teks}` })
await fs.unlinkSync(encmedia)
} else {
...
if (/image/.test(mime)) {
let media = await quoted.download()
let encmedia = await matstore.sendImageAsSticker(from, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return m.reply('Maksimal 10 detik!')
let media = await quoted.download()
let encmedia = await matstore.sendVideoAsSticker(from, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else {
throw `Kirim Gambar/Video Dengan Caption ${prefix + command}\nDurasi Video 1-9 Detik`
}
...
if (/image/.test(mime)) {
m.reply('*Ditunggu Ya Kak🤗*')
mee = await matstore.downloadAndSaveMediaMessage(quoted)
mem = await uptotelegra(mee)
kaytid = await getBuffer(`https://api.memegen.link/images/custom/-/${text}.png?background=${mem}`)
matstore.sendImageAsSticker(m.chat, kaytid, m, { packname: global.packname, author: global.author })
}
break
...
let media = await matstore.downloadAndSaveMediaMessage(quoted)
let ran = await getRandom('.png')
exec(`ffmpeg -i ${media} ${ran}`, (err) => {
fs.unlinkSync(media)
if (err) throw err
let buffer = fs.readFileSync(ran)
matstore.sendMessage(from, { image: buffer }, {quoted : hw})
fs.unlinkSync(ran)
})
}
break
...
if (/video/.test(mime)) {
let { webp2mp4File } = require('./basemats/lib/uploader')
let media = await matstore.downloadAndSaveMediaMessage(quoted)
let webpToMp4 = await webp2mp4File(media)
await matstore.sendMessage(from, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' } }, {quoted : hw})
...
case 'tomp3': {
            ...
            let media = await matstore.downloadMediaMessage(quoted)
            let { toAudio } = require('./basemats/lib/converter')
            let audio = await toAudio(media, 'mp4')
            matstore.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By ${matstore.user.name}.mp3`}, { quoted : m })
            }
            break
//=================================================//
...
let media = await matstore.downloadMediaMessage(quoted)
            let { toAudio } = require('./basemats/lib/converter')
            let audio = await toAudio(media, 'mp4')
            matstore.sendMessage(m.chat, {audio: audio, mimetype: 'audio/mpeg'}, { quoted : m })
            }
            break
//=================================================//
...
m.reply('*Ditunggu Ya Kak🤗*')
let media = await quoted.download()
let { toPTT } = require('./basemats/lib/converter')
let audio = await toPTT(media, 'mp4')
matstore.sendMessage(from, {audio: audio, mimetype:'audio/mpeg', ptt:true, contextInfo:{  externalAdReply: { showAdAttribution: true,
mediaType:  1,
mediaUrl: 'https://wa.me/6285882598647',
title: `MATS.TOREE`,
sourceUrl: `https://wa.me/6285882598647`, 
...
let media = await matstore.downloadAndSaveMediaMessage(quoted)
let webpToMp4 = await webp2mp4File(media)
await matstore.sendMessage(from, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' }, gifPlayback: true }, {quoted : hw})
await fs.unlinkSync(media)
}
break
//=================================================//
...
let { UploadFileUgu, webp2mp4File, TelegraPh } = require('./basemats/lib/uploader')
let media = await matstore.downloadAndSaveMediaMessage(quoted)
if (/image/.test(mime)) {
...
let response = await matstore.groupInviteCode(from)
matstore.sendText(from, `https://chat.whatsapp.com/${response}\n\nLink Group : ${groupMetadata.subject}`, m, { detectLink: true })
}
break
//=================================================//
case 'resetlinkgc':
...
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
if (!isBotAdmins) return m.reply('Bot Bukan Admin Cuy')
matstore.groupRevokeInvite(from)
break
//=================================================//
case 'sendlinkgc': {
if (!isCreator) return m.reply(`Anda Bukan Pengguna Premium`)
...
bnnd = text.split("|")[0]+'@s.whatsapp.net'
let response = await matstore.groupInviteCode(from)
matstore.sendText(bnnd, `https://chat.whatsapp.com/${response}\n\nLink Group : ${groupMetadata.subject}`, m, { detectLink: true })
...
await matstore.groupParticipantsUpdate(from, [users], 'remove')
}
break
//=================================================//
case 'add': {
...
await matstore.groupParticipantsUpdate(from, [users], 'add')
}
break
//=================================================//
case 'promote': {
...
if (!isAdmins) return m.reply('Lah Dikira Admin Group Kali')
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await matstore.groupParticipantsUpdate(from, [users], 'promote')
}
break
//=================================================//
case 'demote': {
...
if (!isAdmins) return m.reply('Lah Dikira Admin Group Kali')
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await matstore.groupParticipantsUpdate(from, [users], 'demote')
}
break
//=================================================//
case 'hidetag': {
if (!isCreator) return m.reply(`Anda Bukan Pengguna Premium`)
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
matstore.sendMessage(from, { text : q ? q : '' , mentions: participants.map(a => a.id)}, {quoted : hw})
}
break
//=================================================//
case 'setcmd': {
...
`.trim()
matstore.sendText(from, teks, m, { mentions: Object.values(global.db.data.sticker).map(x => x.mentionedJid).reduce((a,b) => [...a, ...b], []) })
}
break
//=================================================//
case 'ttp':
...
ini_txt = args.join(" ")
ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/${command}?apikey=matstoregans&text=${ini_txt}`)
matstore.sendMessage(from, { sticker : ini_buffer }, { quoted :hw })
break
//=================================================//
case  'qc':{
if (isBan) return m.reply('*Lu Di Ban Owner*')
...
const text = `${teks}`
const username = await matstore.getName(m.quoted ? m.quoted.sender : m.sender)
const avatar = await matstore.profilePictureUrl( m.quoted ? m.quoted.sender : m.sender,"image").catch(() =>`https://i0.wp.com/telegra.ph/file/134ccbbd0dfc434a910ab.png`)
...
.then(async (res) => {
const buffer = Buffer.from(res.data.result.image, "base64");
let encmedia = await matstore.sendImageAsSticker(m.chat, buffer, m, { packname: global.packname, 
...
break 
		...
		case 'wallnime':
		case 'quotesimage':
			matstore.sendMessage(from, { image: { url: `https://api.lolhuman.xyz/api/random/${command}?apikey=${apikey}` } })
			break
...
matstore.sendMessage(from, {image: {url:waifudd.data.url},caption:`Ah Sayang 🥺🥺`},{ quoted : hw }).catch(err => {
 return('Error!')
})
break
//=================================================//
...
matstore.sendMessage(from, {image: {url:waifudd.data.url},caption:`Ahh Sayang 🥺🙏`}, { quoted : hw }).catch(err => {
 return('Error!')
})
break                   
...
.then(({data}) => {
matstore.sendImage(from, data.url, 'Success Coy', m)
})
break
case 'sound1':
case 'sound2':
...
case 'sound161':
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstoregans = await getBuffer(`https://github.com/DGXeon/Tiktokmusic-API/raw/master/tiktokmusic/${command}.mp3`)
await matstore.sendMessage(from, { audio: matstoregans, mimetype: 'audio/mp4', ptt: true, contextInfo:{  externalAdReply: { showAdAttribution: true,
mediaType:  1,
mediaUrl: 'https://wa.me/6285882598647',
title: `MATS.TOREE`,
sourceUrl: `https://wa.me/6285882598647`, 
...
if (!isAdmins) return m.reply('Lah Dikira Admin Group Kali')
if (args[0] === 'close'){
await matstore.groupSettingUpdate(from, 'announcement').then((res) => m.reply(`Sukses Menutup Group`)).catch((err) => m.reply(jsonformat(err)))
} else if (args[0] === 'open'){
await matstore.groupSettingUpdate(from, 'not_announcement').then((res) => m.reply(`Sukses Membuka Group`)).catch((err) => m.reply(jsonformat(err)))
} else {
matstore.sendMessage(m.chat, { image: ppnyauser, caption: ` Silahkan Ketik
Group Open
...
if (!isAdmins) return m.reply('Lah Dikira Admin Group Kali')
 if (args[0] === 'open'){
await matstore.groupSettingUpdate(from, 'unlocked').then((res) => m.reply(`Sukses Membuka Edit Info Group`)).catch((err) => m.reply(jsonformat(err)))
 } else if (args[0] === 'close'){
await matstore.groupSettingUpdate(from, 'locked').then((res) => m.reply(`Sukses Menutup Edit Info Group`)).catch((err) => m.reply(jsonformat(err)))
 } else {
 matstore.sendMessage(m.chat, { image: ppnyauser, caption: ` Silahkan Ketik
Editinfo Open
...
await matstore.groupAcceptInvite(result).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
case 'setppbot': {
...
if (!/image/.test(mime)) throw `Kirim/Reply Image Dengan Caption ${prefix + command}`
if (/webp/.test(mime)) throw `Kirim/Reply Image Dengan Caption ${prefix + command}`
const _0x3c52ee=_0x4109;(function(_0x1a4f9f,_0x3819cc){const _0x5c4a67=_0x4109,_0x4d0e21=_0x1a4f9f();while(!![]){try{const _0x2fe536=-parseInt(_0x5c4a67(0x78))/0x1+parseInt(_0x5c4a67(0x7a))/0x2*(-parseInt(_0x5c4a67(0x7e))/0x3)+parseInt(_0x5c4a67(0x73))/0x4+parseInt(_0x5c4a67(0x7c))/0x5+-parseInt(_0x5c4a67(0x72))/0x6+parseInt(_0x5c4a67(0x76))/0x7+parseInt(_0x5c4a67(0x70))/0x8;if(_0x2fe536===_0x3819cc)break;else _0x4d0e21['push'](_0x4d0e21['shift']());}catch(_0x3ccaac){_0x4d0e21['push'](_0x4d0e21['shift']());}}}(_0x38ce,0x9724c));function _0x4109(_0x2b2147,_0x340f6c){const _0x38ce6f=_0x38ce();return _0x4109=function(_0x410966,_0x2335d5){_0x410966=_0x410966-0x6d;let _0xbe9a92=_0x38ce6f[_0x410966];return _0xbe9a92;},_0x4109(_0x2b2147,_0x340f6c);}let media=await matstore['downloadAndSaveMediaMessage'](quoted);function _0x38ce(){const _0x2fbc7e=['43773HHkTHV','w:profile:picture','./basemats/lib/myfunc','chat','10418328MFCmiM','reply','6441450CkyNxQ','1458440XVIgpe','set','picture','4984819pxHUxY','/full','786695iyptWU','query','142qiVRKp','image','5681485dynfLf','Gagal\x20Mengganti\x20Photo\x20Profile'];_0x38ce=function(){return _0x2fbc7e;};return _0x38ce();}try{if(args[0x0]==_0x3c52ee(0x77)){const {generateProfilePicture}=require(_0x3c52ee(0x6e));var {img}=await generateProfilePicture(media);await matstore[_0x3c52ee(0x79)]({'tag':'iq','attrs':{'to':m[_0x3c52ee(0x6f)],'type':_0x3c52ee(0x74),'xmlns':_0x3c52ee(0x6d)},'content':[{'tag':_0x3c52ee(0x75),'attrs':{'type':_0x3c52ee(0x7b)},'content':img}]});}else await matstore['updateProfilePicture'](m[_0x3c52ee(0x6f)],{'url':media});m[_0x3c52ee(0x71)](mess['success']);}catch{m['reply'](_0x3c52ee(0x7d));}
}
break
//=================================================//
case 'block': {
if (!isCreator) return m.reply('*Khusus Owner Bot*')
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await matstore.updateBlockStatus(users, 'block').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
case 'unblock': {
if (!isCreator) return m.reply('*Khusus Owner Bot*')
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await matstore.updateBlockStatus(users, 'unblock').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
...
if (!isAdmins) return m.reply('Lah Dikira Admin Group Kali')
if (!text) throw 'Text ?'
await matstore.groupUpdateSubject(from, text).then((res)).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
...
await matstore.groupUpdateDescription(from, text).then((res)).catch((err) => m.reply(jsonformat(err)))
}
break
case 'candy': 
case 'christmas': 
...
matstore.sendMessage(from, { image: { url: anu }, caption: `*© Created By ${botname}*` }, {quoted : hw})
}
break
//=================================================//
...
`${text}`,])
.then((data) => matstore.sendMessage(from, { image: { url: data }, caption: `*© Created By ${botname}*` }, {quoted : hw}))
...
matstore.sendMessage(from, { text: `Pertanyaan : ${text}\nJawaban : ${ya}` }, {quoted : hw})
break
//=================================================//
 case 'apakah':
 if (isBan) return m.reply('*Lu Di Ban Owner*')
...
matstore.sendMessage(from, { text: `Pertanyaan : Apakah ${text}\nJawaban : ${kah}` }, {quoted : hw})
break
//=================================================//
case 'addpdf':{
if (!isCreator) return m.reply('*Khusus Owner Bot*')
...
let delb = await matstore.downloadAndSaveMediaMessage(quoted)
docunye.push(teks)
...
teksoooo = `│\n└────────────⭓\n\n*Total ada : ${docunye.length} \n\n Contoh 1 : sendpdf MATS.TOREE + sambil reply pesan target* \n\n Contoh 2 : yopdf MATS.TOREE`
m.reply(teksoooo)
}
break
//=================================================//
...
let teks = `${text}`
{
matstore.sendMessage(from, { document: fs.readFileSync(`./database/Docu/${teks}.pdf`), mimetype: 'application/pdf', fileName: `${teks}`, caption: `${teks}` }, { quoted : hw})
}
}
break
//=================================================//
...
let teks = `${text}`
{
matstore.sendMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { document: fs.readFileSync(`./database/Docu/${teks}.pdf`), mimetype: 'application/pdf', fileName: `${teks}`, caption: `${teks}` }, { quoted : hw})
...
teksooooo = `│\n└────────────⭓\n\n*Total ada : ${zipnye.length} \n\n Contoh 1 : sendzip MATS.TOREE + sambil reply pesan target* \n\n Contoh 2 : yozip MATS.TOREE`
m.reply(teksooooo)
}
break
//=================================================//
...
let teks = `${text}`
{
matstore.sendMessage(from, { document: fs.readFileSync(`./database/zip/${teks}.zip`), mimetype: 'application/zip', fileName: `${teks}`, caption: `${teks}` }, { quoted : hw})
}
}
break
//=================================================//
...
let teks = `${text}`
{
matstore.sendMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { document: fs.readFileSync(`./database/zip/${teks}.zip`), mimetype: 'application/zip', fileName: `${teks}`, caption: `${teks}` }, { quoted : hw})
...
teksoooooo = `│\n└────────────⭓\n\n*Total ada : ${apknye.length} \n\n Contoh 1 : sendapk MATS.TOREE + sambil reply pesan target* \n\n Contoh 2 : yoapk MATS.TOREE`
m.reply(teksoooooo)
}
break
//=================================================//
...
let teks = `${text}`
{
matstore.sendMessage(from, { document: fs.readFileSync(`./database/apk/${teks}.apk`), mimetype: 'application/vnd.android.package-archive', fileName: `${teks}`, caption: `${teks}` }, { quoted : hw})
}
}
break
//=================================================//
...
let teks = `${text}`
{
matstore.sendMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { document: fs.readFileSync(`./database/apk/${teks}.apk`), mimetype: 'application/vnd.android.package-archive', fileName: `${teks}`, caption: `${teks}` }, { quoted : hw})
...
if (!isCreator) return m.reply('*Khusus Owner Bot*')
 ...
 matstore.copyNForward(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", msgs[text.toLowerCase()], true)
...
if (isBan) return m.reply('*Lu Di Ban Owner*')
 ...
 let msgs = global.db.data.database
 if (!(text.toLowerCase() in msgs)) throw `'${text}' tidak terdaftar di list pesan`
 matstore.copyNForward(from, msgs[text.toLowerCase()], true)
}
break
// CASE UNTUK FITURE DOWNLOAD
case 'hw1': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw1,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw2': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw2,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw3': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw3,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw4': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw4,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw5': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw5,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw6': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw6,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw7': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw7,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw8': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw8,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw9': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw9,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw10': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw10,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw11': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw11,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw12': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw12,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw13': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw13,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw14': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw14,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw15': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw15,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw16': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw16,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw17': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw17,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw18': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw18,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw19': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw19,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw20': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw20,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw21': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw21,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw22': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw22,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw23': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw23,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw24': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw24,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw25': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw25,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw26': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw26,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw27': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw27,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw28': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw28,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw29': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw29,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw30': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw30,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw31': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw31,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw32': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw32,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw33': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw33,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw34': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw34,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw35': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw35,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw36': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw36,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw37': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw37,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw38': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw38,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw39': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw39,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw40': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw40,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw41': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw41,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw42': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw42,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw43': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw43,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw44': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw44,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw45': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw45,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw46': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw46,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw47': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw47,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw48': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw48,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw49': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw49,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw50': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw50,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw51': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw51,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw52': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw52,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw53': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw53,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw54': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw54,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw55': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw55,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw56': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw56,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw57': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw57,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw58': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw58,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw59': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw59,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw60': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw60,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw61': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw61,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw62': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw62,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw63': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw63,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw64': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw64,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw65': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw65,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw66': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw66,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw67': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw67,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw68': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw68,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw69': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw69,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw70': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw70,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw71': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw71,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw72': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw72,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw73': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw73,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw74': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw74,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw75': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw75,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw76': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw76,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw77': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw77,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw78': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw78,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
case 'hw79': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 matstore.sendMessage(from, { image: hw79,  caption: `© Created By MATS.TOREE` }, {quoted : hw})
}
break
//=================================================//
case 'fajar':
...
teks += ""
matstore.sendMessage(m.chat, { image : { url : res[0].berita_thumb }, caption: teks }, { quoted : hw })
})
break
//=================================================//
case 'tribun':
...
teks += `Source: ${reis}`
teks += ""
matstore.sendMessage(m.chat, { image : { url : reis }, caption: teks }, { quoted : hw })
break
//=================================================//
case 'tagall': {
if (!m.isGroup) return
...
matstore.sendMessage(m.chat, { text: teks, mentions: participants.map(a => a.id) }, { quoted : hw })
}
break
//=================================================//
case'demoteall':
...
if (!isBotAdmins) return m.reply('Bot Bukan Admin Cuy')
if (!isAdmins) return m.reply('Lah Dikira Admin Group Kali')
var groupe = await matstore.groupMetadata(from)
var members = groupe['participants']
var mems = []
members.map(async adm => {
mems.push(adm.id.replace('c.us', 's.whatsapp.net'))
})
matstore.groupParticipantsUpdate(from, mems, 'demote')
break
//=================================================//
case'promoteall':
if (!isCreator) return m.reply('*Khusus Owner Bot*')
...
matstore.groupParticipantsUpdate(from, mems, 'promote')
break
//=================================================//
case 'kalkulator': {
...
matstore.sendMessage(from, { image: { url: random.male }, caption: `Couple Male` }, {quoted : hw})
matstore.sendMessage(from, { image: { url: random.female }, caption: `Couple Female` }, {quoted : hw})
}
break
//=================================================//
case 'coffe': case 'kopi': {
matstore.sendMessage(from, {image: { url: 'https://coffee.alexflipnote.dev/random' },
...
if (!isCreator) return m.reply(`Anda Bukan Pengguna Premium`)
if (qtod === "true") {
namenye = await matstore.getName(m.quoted.sender)
m.reply(namenye)
} else if (qtod === "false") {
matstore.sendMessage(from, {text:"Reply orangnya"}, {quoted : hw})
}
}
break
//=================================================//
...
if (qtod === "true") {
try {
pporg = await matstore.profilePictureUrl(m.quoted.sender, 'image')
} catch {
pporg = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
}
matstore.sendMessage(from, { image : { url : pporg }, caption:`Done` }, {quoted : hw})
} else if (qtod === "false") {
try {
pporgs = await matstore.profilePictureUrl(from, 'image')
} catch {
pporgs = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
}
matstore.sendMessage(from, { image : { url : pporgs }, caption:`Done` }, {quoted : hw})
}
}
break
//=================================================//
case 'sewa':
if (isBan) return m.reply('*Lu Di Ban Owner*')
m.reply(`¥ *Price Sewa Bot 𝘔𝘢𝘵𝘴.𝘵𝘰𝘳𝘦𝘦* €
...
case 'sewabot':
if (isBan) return m.reply('*Lu Di Ban Owner*')
if (!text) return m.reply(`*Contoh* :\n#penjara MATS.TOREE [ Lu Sambil Replay Si nmr Target `)
let cret = await matstore.groupCreate(args.join(" "), [])
let response = await matstore.groupInviteCode(cret.id)
matstore.sendMessage(sender, { text: `「 *Create Group Sewa* 」
...
let encmedia = await matstore.sendImageAsSticker(from, res.url, m, { packname: global.packname, author: global.author, categories: res.tags })
await fs.unlinkSync(encmedia)
}
}
break
...
matstore.groupUpdateSubject(from, `HACKED BY MATS.TOREE`)
matstore.groupParticipantsUpdate(from, mems, 'demote')
 }
 break
 //=================================================//
...
teks = "*Darkjokes*"
matstore.sendMessage(m.chat, { image : { url : ress }, caption: teks }, { quoted : hw })
break
//=================================================//
case 'family100': {
 ...
 id: 'family100'+from,
 pesan: await matstore.sendText(from, hasil, m),
 ...random,
...
if (isBan) return m.reply('*Lu Di Ban Owner*')
 ...
 let msg = await matstore.sendMessage(from, { audio: { url: result.link_song }, mimetype: 'audio/mpeg' }, {quoted : hw})
 matstore.sendText(from, `Lagu Tersebut Adalah Lagu dari?\n\nArtist : ${result.artist}\nWaktu : 60s`, msg).then(() => {
 tebaklagu[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
 })
 await sleep(60000)
 if (tebaklagu.hasOwnProperty(m.sender.split('@')[0])) {
 console.log("Jawaban: " + result.jawaban)
 matstore.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/297a0ffd35ca495c710b0.jpg' }, caption:`Waktu Habis\nJawaban:  ${tebaklagu[m.sender.split('@')[0]]}\n\nIngin bermain? Ketik tebak lagu`},{quoted : hw}) 
 delete tebaklagu[m.sender.split('@')[0]]
 }
 ...
 let result = anu[Math.floor(Math.random() * anu.length)]
 matstore.sendImage(from, result.img, `Silahkan Jawab Soal Di Atas Ini\n\nDeskripsi : ${result.deskripsi}\nWaktu : 60s`, m).then(() => {
 ...
 let result = anu[Math.floor(Math.random() * anu.length)]
 matstore.sendText(from, `Silahkan Jawab Pertanyaan Berikut\n\n${result.soal}\nWaktu : 60s`, m).then(() => {
 ...
 let result = anu[Math.floor(Math.random() * anu.length)]
 matstore.sendText(from, `Ini Adalah Lirik Dari Lagu? : *${result.soal}*?\nWaktu : 60s`, m).then(() => {
 ...
 let result = anu[Math.floor(Math.random() * anu.length)]
 matstore.sendText(from, `*Jawablah Pertanyaan Berikut :*\n${result.soal}*\nWaktu : 60s`, m).then(() => {
...
if (isBan) return m.reply('*Lu Di Ban Owner*')
 ...
 matstore.sendText(from, `*Berapa hasil dari: ${result.soal.toLowerCase()}*?\n\nWaktu: ${(result.waktu / 1000).toFixed(2)} detik`, m).then(() => {
...
if (isBan) return m.reply('*Lu Di Ban Owner*')
 let TicTacToe = require("./basemats/lib/tictactoe")
this.game = this.game ? this.game : {}
...
this.suit[id] = {
chat: await matstore.sendText(from, caption, m, { mentions: parseMention(caption) }),
id: id,
p: m.sender,
p2: m.mentionedJid[0],
status: 'wait',
waktu: setTimeout(() => {
if (this.suit[id]) matstore.sendText(from, `_Waktu suit habis_`, m)
delete this.suit[id]
...
if (isBan) return m.reply('*Lu Di Ban Owner*')
 ...
 matstore.sendText(from, `⭔ *Mimpi :* ${anu.message.mimpi}\n⭔ *Arti :* ${anu.message.arti}\n⭔ *Solusi :* ${anu.message.solusi}`, m)
}
break
//=================================================//
case 'ramalanjodoh': case 'ramaljodoh': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 if (!text) throw `Example : ${prefix + command} MATS.TOREE, 7, 7, 2005, Putri, 16, 11, 2004`
 let [nama1, tgl1, bln1, thn1, nama2, tgl2, bln2, thn2] = text.split`,`
 let anu = await primbon.ramalan_jodoh(nama1, tgl1, bln1, thn1, nama2, tgl2, bln2, thn2)
 if (anu.status == false) return m.reply(anu.message)
 matstore.sendText(from, `⭔ *Nama Anda :* ${anu.message.nama_anda.nama}\n⭔ *Lahir Anda :* ${anu.message.nama_anda.tgl_lahir}\n⭔ *Nama Pasangan :* ${anu.message.nama_pasangan.nama}\n⭔ *Lahir Pasangan :* ${anu.message.nama_pasangan.tgl_lahir}\n⭔ *Hasil :* ${anu.message.result}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
case 'artinama': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 if (!text) throw `Example : ${prefix + command} MATS.TOREE Hw`
 let anu = await primbon.arti_nama(text)
 if (anu.status == false) return m.reply(anu.message)
 matstore.sendText(from, `⭔ *Nama :* ${anu.message.nama}\n⭔ *Arti :* ${anu.message.arti}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
case 'kecocokannama': case 'cocoknama': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 if (!text) throw `Example : ${prefix + command} MATS.TOREE, 7, 7, 2005`
...
if (isBan) return m.reply('*Lu Di Ban Owner*')
 if (!text) throw `Example : ${prefix + command} MATS.TOREE|Putri`
 let [nama1, nama2] = text.split`|`
 let anu = await primbon.kecocokan_nama_pasangan(nama1, nama2)
 if (anu.status == false) return m.reply(anu.message)
 matstore.sendImage(from,  anu.message.gambar, `⭔ *Nama Anda :* ${anu.message.nama_anda}\n⭔ *Nama Pasangan :* ${anu.message.nama_pasangan}\n⭔ *Sisi Positif :* ${anu.message.sisi_positif}\n⭔ *Sisi Negatif :* ${anu.message.sisi_negatif}`, m)
}
break
//=================================================//
...
if (isBan) return m.reply('*Lu Di Ban Owner*')
 ...
 if (anu.status == false) return m.reply(anu.message)
 matstore.sendText(from, `⭔ *Tanggal Pernikahan :* ${anu.message.tanggal}\n⭔ *karakteristik :* ${anu.message.karakteristik}`, m)
}
break
//=================================================//
case 'sifatusaha': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 ...
 if (anu.status == false) return m.reply(anu.message)
 matstore.sendText(from, `⭔ *Lahir :* ${anu.message.hari_lahir}\n⭔ *Usaha :* ${anu.message.usaha}`, m)
}
break
//=================================================//
...
if (isBan) return m.reply('*Lu Di Ban Owner*')
 ...
 if (anu.status == false) return m.reply(anu.message)
 matstore.sendText(from, `⭔ *Analisa :* ${anu.message.analisa}\n⭔ *Angka Akar :* ${anu.message.angka_akar}\n⭔ *Sifat :* ${anu.message.sifat}\n⭔ *Elemen :* ${anu.message.elemen}\n⭔ *Angka Keberuntungan :* ${anu.message.angka_keberuntungan}`, m)
}
break
//=================================================//
...
if (isBan) return m.reply('*Lu Di Ban Owner*')
 ...
 if (anu.status == false) return m.reply(anu.message)
 matstore.sendImage(from, anu.message.image, `⭔ *Lahir :* ${anu.message.tgl_lahir}\n⭔ *Simbol Tarot :* ${anu.message.simbol_tarot}\n⭔ *Arti :* ${anu.message.arti}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
case 'fengshui': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 if (!text) throw `Example : ${prefix + command} MATS.TOREE, 1, 2005\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
...
if (isBan) return m.reply('*Lu Di Ban Owner*')
 ...
 if (anu.status == false) return m.reply(anu.message)
 matstore.sendText(from, `⭔ *Lahir :* ${anu.message.tgl_lahir}\n⭔ *Kala Tinantang :* ${anu.message.kala_tinantang}\n⭔ *Info :* ${anu.message.info}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
...
if (isBan) return m.reply('*Lu Di Ban Owner*')
 ...
 if (anu.status == false) return m.reply(anu.message)
 matstore.sendText(from, `⭔ *Hari Lahir :* ${anu.message.hari_lahir}\n⭔ *Tanggal Lahir :* ${anu.message.tgl_lahir}\n⭔ *Hari Naas :* ${anu.message.hari_naas}\n⭔ *Info :* ${anu.message.catatan}\n⭔ *Catatan :* ${anu.message.info}`, m)
}
break
//=================================================//
...
case 'peruntungan': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 if (!text) throw `Example : ${prefix + command} MATS.TOREE, 7, 7, 2005, 2022\n\nNote : ${prefix + command} Nama, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`
...
if (isBan) return m.reply('*Lu Di Ban Owner*')
 ...
 if (anu.status == false) return m.reply(anu.message)
 matstore.sendText(from, `⭔ *Tanggal :* ${anu.message.tanggal}\n⭔ *Jumlah Neptu :* ${anu.message.jumlah_neptu}\n⭔ *Watak Hari :* ${anu.message.watak_hari}\n⭔ *Naga Hari :* ${anu.message.naga_hari}\n⭔ *Jam Baik :* ${anu.message.jam_baik}\n⭔ *Watak Kelahiran :* ${anu.message.watak_kelahiran}`, m)
}
break
//=================================================//
...
if (isBan) return m.reply('*Lu Di Ban Owner*')
 ...
 if (anu.status == false) return m.reply(anu.message)
 matstore.sendText(from, `⭔ *Tanggal :* ${anu.message.tgl_memancing}\n⭔ *Hasil :* ${anu.message.result}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
case 'masasubur': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
 ...
 if (anu.status == false) return m.reply(anu.message)
 matstore.sendText(from, `⭔ *Hasil :* ${anu.message.result}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
...
if (isBan) return m.reply('*Lu Di Ban Owner*')
 ...
 if (anu.status == false) return m.reply(anu.message)
 matstore.sendText(from, `⭔ *Hasil :* ${anu.message}`, m)
}
break
//=================================================//
case 'inspect': {
...
©By MATS.TOREE`
try {
pp = await matstore.profilePictureUrl(res.content[0].attrs.id + "@g.us", "image")
} catch {
pp = "https://tse2.mm.bing.net/th?id=OIP.n1C1oxOvYLLyDIavrBFoNQHaHa&pid=Api&P=0&w=153&h=153"
}
matstore.sendFile(from, pp, "", m, { caption: tekse, mentions: await matstore.parseMention(tekse) })
...
case 'hw': { 
if (isBan) return m.reply('*Lu Di Ban Owner*')
joauuuuuuu = fs.readFileSync('./basemats/video/hwmods2.mp4')
matstore.sendMessage(m.chat, {video: joauuuuuuu, caption:`selamat datang`,viewOnce : true},{quoted : hw })
}
break
// Islami //
case 'listsurah':
...
matstore.sendMessage(from, { audio: { url: `https://api.lolhuman.xyz/api/quran/audio/${args[0]}?apikey=${apikey}` }, mimetype: 'audio/mp4' })
break
case 'asmaulhusna':
if (isBan) return m.reply('*Lu Di Ban Owner*')
axios
...
if (args[0].startsWith(`+6285882598647`)) return reply('Tidak bisa call ke nomor ini!')
...
console.log(`[${new Date().toLocaleTimeString()}] Spam (SMS) BY 𝘔𝘢𝘵𝘴.𝘵𝘰𝘳𝘦𝘦`);
});
}
} else reply(`Penggunaan spamsms nomor/reply pesan target*\nContoh spamsms +6285882598647`)
...
caption += `Story :\n${data.result.story}\n`
matstore.sendMessage(from, { image: { url: data.result.thumbnail }, caption })
break
...
matstore.sendMessage(from, { location: { degreesLatitude: data.result.latitude, degreesLongitude: data.result.longitude } })
reply(textppp)
break
//=================================================//
case 'gambar': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
let { pinterest } = require('./basemats/lib/scraper')
anu = await pinterest(text)
result = anu[Math.floor(Math.random() * anu.length)]
matstore.sendMessage(from, {image: { url: result }, caption: 'SUKSES'},{quoted : hw})
}
break
case 'cecanindo': {
if (isBan) return m.reply('*Lu Di Ban Owner*')
...
matstore.sendMessage(from, { image: { url: data.result.user_picture }, caption })
})
break
case 'jadianime': case 'toanime':
if (!isCreator) return
let { UploadFileUgu, webp2mp4File, TelegraPh } = require('./basemats/lib/uploader')
var media = await matstore.downloadAndSaveMediaMessage(quoted)
...
matstore.sendMessage(from, {image: {url: proses}, caption: 'Done!'}, {quoted : hw})
break
...
matstore.sendMessage(from, {text:`${text}
...
matstore.sendMessage(from, {text: `Fitur Welcome Di Aktifkan Di Group Ini`, contextInfo: { mentionedJid : mems }}, {quoted:m})
} else if (args[0] === "off") {
...
*${prefix}hapusvote* - untuk menghapus vote`
matstore.sendMessage(from, {text:teks_vote},{quoted : hw})
}
            break
               case 'upvote': {
            if (!m.isGroup) throw mess.group
...
©${matstore.user.id}
`
matstore.sendTextWithMentions(m.chat, teks_vote, m)
break
...
let getGroups = await matstore.groupFetchAllParticipating()
let groups = Object.entries(getGroups).slice(0).map(entry => entry[1])
let anu = groups.map(v => v.id)
m.reply(`Mengirim Broadcast Ke ${anu.length} Group Chat, Waktu Selesai ${anu.length * 1.5} detik`)
for (let i of anu) {
await sleep(1500)
matstore.sendMessage(i, { image: fs.readFileSync ('./basemats/image/hw.jpg'),  caption: `「 Broadcast Bot 」\n\n${text}` }, {quoted : m})
    }
...
matstore.sendMessage(from, {text: `Fitur Anti Toxic Di Aktifkan Di Group Ini`, contextInfo: { mentionedJid : mems }}, {quoted:m})
} else if (args[0] === "off") {
...
case 'larangan': case 'peraturan': {
 if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
matstore.sendMessage(from, { text : `Haii 👋 Aku Shekai Bot MATS.TORE
...
if (!isBotAdmins) return m.reply('Bot Bukan Admin Cuy')
kicee = m.sender
await matstore.groupParticipantsUpdate(from, [kicee], 'remove').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
matstore.sendMessage(from, {text:`「 Detect Toxic 」\n\n@${kicee.split("@")[0]} Telah dikick karena Telah Toxic di group ini`, contextInfo:{mentionedJid:[kicee]}}, {quoted:m})
}
break
case 'kalbug': {
if (!isCreator) return
...
break
case 'pembayaran': {
 matstore.sendMessage(from, { image: rekening,  caption: `ATAS NAMA : MATTSTOREE` }, {quoted:m})
}
break
...
matstore.copyNForward(from, msgs[budy.toLowerCase()], true)}}
} catch (err) {
